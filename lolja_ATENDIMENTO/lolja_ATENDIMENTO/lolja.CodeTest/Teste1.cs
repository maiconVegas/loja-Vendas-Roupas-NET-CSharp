...
namespace lolja_ATENDIMENTO.lolja.CodeTest
{
    public class Teste1
    {
...
// TESTE 10 - testando classe itemvenda e List<ItemVenda>
Console.WriteLine();
Console.WriteLine();
Console.WriteLine("/////////////////////////////   TESTANDO CLASSE ItemVenda e List   ////////////////////");
...
var produtoVenda1 = estoque.Itens.ElementAt(0).Key;
var quantidadeProdutoVenda1 = estoque.RemoverProduto(produtoVenda1, 2);

var produtoVenda2 = estoque.Itens.ElementAt(1).Key;
var quantidadeProdutoVenda2 = estoque.RemoverProduto(produtoVenda2, 3);

ItemVenda itemvenda1 = new ItemVenda(produtoVenda1, quantidadeProdutoVenda1);
ItemVenda itemvenda2 = new ItemVenda(produtoVenda2, quantidadeProdutoVenda2);
Console.WriteLine("prdido");

Console.WriteLine(itemvenda1.Item.Nome);
Console.WriteLine(itemvenda1.Quantidade);
Console.WriteLine(itemvenda2.Item.Nome);
Console.WriteLine(itemvenda2.Quantidade);
Console.WriteLine("/////");
foreach (var item in estoque.Itens)
{
    Console.WriteLine(item.Key.Nome);
...
Console.WriteLine();
Console.WriteLine("Testando a list");
List<ItemVenda> listadeItem = new List<ItemVenda>();
listadeItem.Add(itemvenda1);
listadeItem.Add(itemvenda2);
double precoTOTAL = 0;
foreach (var item in listadeItem)
{
    Console.WriteLine(item.Item.Nome);
    Console.WriteLine(item.Quantidade);
    precoTOTAL += item.Item.Preco * item.Quantidade;
}
Console.WriteLine($"Preço total: {precoTOTAL}");

// TESTE 11 - testando classe Venda
Console.WriteLine();
Console.WriteLine();
Console.WriteLine("/////////////////////////////   TESTANDO CLASSE VENDA   ////////////////////");

Venda venda1 = new Venda(cliente1, listadeItem);
Console.WriteLine(venda1.ItensVenda.Count);
Console.WriteLine(venda1.Preco_Total);
